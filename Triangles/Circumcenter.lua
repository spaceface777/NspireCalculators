...
local CX = 0
local CY = 0
local Midpoint_AB_X = 0
local Midpoint_AB_Y = 0
local Midpoint_BC_X = 0
local Midpoint_BC_Y = 0
local Midpoint_AC_X = 0
local Midpoint_AC_Y = 0
local AB_Slope = 0
local BC_Slope = 0
local AC_Slope = 0
local AB_P_Slope = 0
...
local Counter = 0
local answer = "" 
local myTable = {"Circumcenter calculator","("..AX..","..AY.."),("..BX..","..BY.."),("..CX..","..CY..")", answer, "Type in the value of AX"} 
...
function on.resize() 
    ...
    answer = "" 
    myTable = {"Circumcenter calculator","("..AX..","..AY.."),("..BX..","..BY.."),("..CX..","..CY..")", answer, myTable[4]} 
    screen:invalidate() 
end 
...
function on.reset() 
    ...
    counter = 0
    Counter = 0
    myTable = {"Circumcenter calculator","("..AX..","..AY.."),("..BX..","..BY.."),("..CX..","..CY..")", answer, "Type in the value of AX"} 
    screen:invalidate() 
end 
...
function on.enterKey() 
    if answer == "" then 
        ...
        myTable[4] = "The circumcenter is (" ..  Intersection_X .. "," .. Intersection_Y .. ")." 
        if Intersection_X == "undef" then myTable[4] = "YEET" end
        on.resize()
    end 
    end
    end 
