...
local counter = 0
local answer = "" 
local myTable = {"Slope calculator","("..X1..","..Y1.."),("..X2..","..Y2..")", answer, "Type in the value of X1"} 
...
function on.resize() 
    ...
    answer = "" 
    myTable = {"Slope calculator","("..X1..","..Y1.."),("..X2..","..Y2..")", answer, myTable[4]} 
    screen:invalidate() 
end 
...
function on.reset() 
    ...
    counter = 0
    answer = "" 
    myTable = {"Slope calculator","("..X1..","..Y1.."),("..X2..","..Y2..")", answer, "Type in the value of X1"} 
    screen:invalidate() 
end 
